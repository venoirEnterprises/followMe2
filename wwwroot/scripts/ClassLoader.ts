...
const gameProperties = new FollowMeDefinition()
...
function addGameObject (ObjIncoming): void {
  switch (ObjIncoming.type) {
    case 'surface':
      const newSurface = new Surface(ObjIncoming.fan, ObjIncoming.surfaceAnimationCollection)
      ...
      break
    case 'Item':
      const newItem = new Item(ObjIncoming.message)
      ...
      break
    case 'Weapon':
      const newWeapon = new Weapon(ObjIncoming.hurt, ObjIncoming.rate, ObjIncoming.weaponLevel)
      ...
      break
    case 'checkpoint':
      const newCheckpoint = new Checkpoint(ObjIncoming.checkpoint, ObjIncoming.newLevel, 1, ObjIncoming.messageForKey, ObjIncoming.levelName)
      ...
      break
    case 'Teleport':
      const newTeleport = new Teleport(ObjIncoming.world, ObjIncoming.level, ObjIncoming.whyLocked, ObjIncoming.teleportAllowed)
      ...
      break
    case 'Cave':
      const newCave = new Cave(ObjIncoming.entrance, ObjIncoming.caveWall, ObjIncoming.caveCeiling, ObjIncoming.xMove, ObjIncoming.yMove)
      ...
      break
    case 'enemies':
      const newEnemy = new Enemy(ObjIncoming.hurt, ObjIncoming.fly)
